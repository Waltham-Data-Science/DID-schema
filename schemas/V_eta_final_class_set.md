...
## ⑦ Acquisition & infra (keep) (8)
`image_stack`, `image_stack_parameters`, `projectvar`, `subject_group`, `treatment`, `treatment_drug`, `treatment_transfer`, `virus_injection`
