# V_eta — The Final Class Set (180 persist)
...
## ③ Quantity & substance composites (data_type) (44)
`acceleration`, `amount`, `angle`, `angular_velocity`, `area`, `capacitance`, `charge`, `chemical`, `concentration`, `conductance`, `contrast_sensitivity`, `count`, `current`, `date`, `dose`, `energy`, `force`, `formulation`, `frequency`, `gain`, `harmonic_component`, `image`, `intensity`, `label`, `length`, `logical`, `mass`, `ph`, `polynomial`, `position`, `power`, `pressure`, `receptive_field`, `resistance`, `score`, `temperature`, `term`, `time`, `timed_sequence`, `tuning_curve`, `velocity`, `visual_grating`, `voltage`, `volume`
