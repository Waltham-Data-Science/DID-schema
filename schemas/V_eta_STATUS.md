...
| build: migrator files inspected | 176 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 150 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 26 |
| build: V_zeta files DELIBERATELY EXCLUDED (`+migrators`, `+migrators_i`, `+migrators_e`) | 38 |
| build: migrator lines inspected | 39649 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 27045 |
...
|---|---|---|---|---|---|---|---|---|
| `acquisition_epoch` | epoch | (b) | 6 consuming reference(s) (1 per-document migrator, 5 batch post-pass); minted as a document class at 1 site(s) (1 per-document migrator) | 1 (1+0) | 1 (1+0) | - | 39 (29+10) | n/a -- not measured |
...
| `epoch_bounded_reference` | time_reference | (b) | 6 consuming reference(s) (6 per-document migrator) | 2 (2+0) discounted | 3 (3+0) | 2 (2+0) | 35 (31+4) | n/a -- not measured |
...
- `acquisition_epoch` (epoch) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/ensembleMembership.m:705 (guard)`; consumed at 5 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:1645 (guard)`, `DID-matlab:convert/epochMint.m:1646 (field_read)`, `DID-matlab:convert/epochMint.m:1647 (field_read)`, `DID-matlab:convert/epochMint.m:1650 (field_read)`, `DID-matlab:convert/epochMint.m:661 (guard)`; MINTED as a document class at 1 site(s), per-document migrator: `DID-matlab:migrators_j/element_epoch.m:130 (emitted_class)`; a block of this name is WRITTEN at 1 site(s), per-document migrator: `DID-matlab:migrators_j/element_epoch.m:132 (field_write)`; mentioned in 29 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:664 (comment_mention)`, `DID-matlab:migrators_j/binaryseries_parameters.m:39 (comment_mention)`, `DID-matlab:migrators_j/daqreader_image_epochdata_ingested.m:162 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:10 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:100 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:102 (comment_mention)` ...; mentioned in 10 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:1634 (comment_mention)`, `DID-matlab:convert/epochMint.m:1704 (comment_mention)`, `DID-matlab:convert/epochMint.m:406 (comment_mention)`, `DID-matlab:convert/epochMint.m:408 (comment_mention)`, `DID-matlab:convert/epochMint.m:622 (comment_mention)`, `DID-matlab:convert/epochMint.m:629 (comment_mention)` ...
...
- `time_reference` (time_reference) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/epochAnchorFold.m:432 (guard)`; consumed at 1 site(s), batch post-pass: `DID-matlab:convert/resolveSessionAnchors.m:560 (guard)`; a block of this name is WRITTEN at 15 site(s), per-document migrator: `DID-matlab:migrators_j/fitcurve.m:153 (field_write)`, `DID-matlab:migrators_j/image_stack.m:283 (field_write)`, `DID-matlab:migrators_j/jrclust_clusters.m:89 (field_write)`, `DID-matlab:migrators_j/neuron_extracellular.m:122 (field_write)`, `DID-matlab:migrators_j/ontology_table_row.m:280 (field_write)`, `DID-matlab:migrators_j/ontology_table_row.m:874 (field_write)` ...; a block of this name is WRITTEN at 3 site(s), batch post-pass: `DID-matlab:convert/resolveDeferredBaths.m:394 (field_write)`, `DID-matlab:convert/resolveDeferredBaths.m:443 (field_write)`, `DID-matlab:convert/resolveValidIntervals.m:965 (field_write)`; NAMED as a string value at 19 site(s), per-document migrator: `DID-matlab:migrators_j/fitcurve.m:147 (named)`, `DID-matlab:migrators_j/image_stack.m:279 (named)`, `DID-matlab:migrators_j/jrclust_clusters.m:85 (named)`, `DID-matlab:migrators_j/neuron_extracellular.m:118 (named)`, `DID-matlab:migrators_j/ontology_table_row.m:276 (named)`, `DID-matlab:migrators_j/ontology_table_row.m:869 (named)` ...; NAMED as a string value at 5 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:1721 (named)`, `DID-matlab:convert/resolveDeferredBaths.m:386 (named)`, `DID-matlab:convert/resolveDeferredBaths.m:438 (named)`, `DID-matlab:convert/resolveSessionAnchors.m:550 (named)`, `DID-matlab:convert/resolveValidIntervals.m:955 (named)`; mentioned in 36 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/daqreader_epochdata_ingested.m:21 (comment_mention)`, `DID-matlab:migrators_j/neuron_extracellular.m:48 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:172 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:196 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:199 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:214 (comment_mention)` ...; mentioned in 5 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:1670 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:22 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:254 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:269 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:271 (comment_mention)`
...
**DENOMINATOR: 23 signed families. 15 named at least one decided target class and were checked against the built tree; 8 named none and are UNCHECKED HERE.**

Across the 15 checked: 30 distinct target class(es), 30 present in the built set, 0 not.
