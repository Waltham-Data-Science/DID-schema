...
| build: migrator files inspected | 183 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 155 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 28 |
| build: V_zeta files DELIBERATELY EXCLUDED (`+migrators`, `+migrators_i`, `+migrators_e`) | 38 |
| build: migrator lines inspected | 45256 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30187 |
...
| 2 | `b.document_class = classBlock('<class>', {supers})` | 20 | 19 | 1 |
...
| `epochid` | epoch | (b) | 15 consuming reference(s) (14 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 16 (10+6) | 101 (79+22) | n/a -- not measured |
...
| `syncgraph` | sync configuration | (b) | migrator `DID-matlab:migrators_j/syncgraph.m`; 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `clock_alignment_policy` | - | - | - | 49 (30+19) | n/a -- not measured |
...
| `syncrule_mapping` | sync mapping | (b) | migrator `DID-matlab:migrators_j/syncrule_mapping.m`; 7 consuming reference(s) (2 per-document migrator, 5 batch post-pass); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `clock_alignment` | 1 (1+0) | 1 (1+0) | 2 (0+2) | 46 (26+20) | n/a -- not measured |
| `time_reference` | time_reference | (b) | 5 consuming reference(s) (4 per-document migrator, 1 batch post-pass) | - | 18 (15+3) | 25 (18+7) | 45 (36+9) | n/a -- not measured |
...
Across the 16 checked: 29 distinct target class(es), 29 present in the built set, 0 not.
