...
| build: migrator lines inspected | 36559 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 24776 |
...
| `syncrule_mapping` | sync mapping | (b) | migrator `DID-matlab:migrators_j/syncrule_mapping.m`; 2 consuming reference(s) (2 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `clock_alignment` | 1 (1+0) | 1 (1+0) | - | 27 (24+3) | n/a -- not measured |
