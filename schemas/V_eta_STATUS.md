...
| build: migrator files inspected | 180 |
...
| build: migrator lines inspected | 42405 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 29780 |
...
|---|---|---|---|---|
| 1 | `b.document_class = struct('class_name', '<class>', ...)` | 69 | 54 | 15 |
...
| `app` | software | (b) | 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `software` | - | 2 (1+1) | 1 (0+1) | 194 (158+36) | n/a -- not measured |
...
| `ngrid` | image / ngrid | (b) | 8 consuming reference(s) (8 per-document migrator) | - | 1 (1+0) | - | 87 (84+3) | n/a -- not measured |
...
| `stimulus_presentation` | stimulus | (b) | migrator `DID-matlab:migrators_j/stimulus_presentation.m`; 6 consuming reference(s) (6 per-document migrator); decided target(s) built: `timed_sequence`, `timed_sequence_manipulation` | - | - | - | 43 (41+2) | n/a -- not measured |
...
- `ensemble` (ensemble) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/ensembleMembership.m:438 (guard)`; mentioned in 23 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/element.m:112 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:89 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:91 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:92 (comment_mention)`, `DID-matlab:migrators_j/hartley_calc.m:151 (comment_mention)`, `DID-matlab:migrators_j/private/jAcquisitionChannels.m:73 (comment_mention)` ...; mentioned in 2 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/resolveLawnPlateSubjects.m:1358 (comment_mention)`, `DID-matlab:convert/resolveResponseParameters.m:68 (comment_mention)`; target(s) BUILT: `subject`, `directed_relation`, `sampled_body`
