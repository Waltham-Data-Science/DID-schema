...
| build: migrator lines inspected | 39807 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 27203 |
...
| `DID-matlab:migrators_j/private/jRecordingObservation.m:242` | `e.class` |
...
- `ensemble` (ensemble) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/ensembleMembership.m:382 (guard)`; mentioned in 20 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/element.m:112 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:58 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:60 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:61 (comment_mention)`, `DID-matlab:migrators_j/private/jAcquisitionChannels.m:73 (comment_mention)`, `DID-matlab:migrators_j/pyraview.m:267 (comment_mention)` ...; mentioned in 2 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/resolveLawnPlateSubjects.m:1358 (comment_mention)`, `DID-matlab:convert/resolveResponseParameters.m:68 (comment_mention)`; target(s) BUILT: `subject`, `directed_relation`, `sampled_body`
