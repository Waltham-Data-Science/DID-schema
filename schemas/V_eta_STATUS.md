...
| build: migrator files inspected | 181 |
...
| build: migrator lines inspected | 43895 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30474 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 13421 |
...
| `epochid` | epoch | (b) | 15 consuming reference(s) (14 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 15 (10+5) | 99 (78+21) | n/a -- not measured |
...
| `syncgraph` | sync configuration | (b) | migrator `DID-matlab:migrators_j/syncgraph.m`; 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `clock_alignment_policy` | - | - | - | 49 (31+18) | n/a -- not measured |
...
| `syncrule_mapping` | sync mapping | (b) | migrator `DID-matlab:migrators_j/syncrule_mapping.m`; 7 consuming reference(s) (2 per-document migrator, 5 batch post-pass); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `clock_alignment` | 1 (1+0) | 1 (1+0) | 2 (0+2) | 46 (27+19) | n/a -- not measured |
| `time_reference` | time_reference | (b) | 5 consuming reference(s) (4 per-document migrator, 1 batch post-pass) | - | 18 (15+3) | 25 (19+6) | 44 (37+7) | n/a -- not measured |
...
- `epochfiles_ingested` (epoch) -- migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; mentioned in 18 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:160 (comment_mention)`, `DID-matlab:migrators_j/Contents.m:665 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:115 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:192 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:203 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:220 (comment_mention)` ...; mentioned in 7 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:169 (comment_mention)`, `DID-matlab:convert/epochMint.m:186 (comment_mention)`, `DID-matlab:convert/epochMint.m:225 (comment_mention)`, `DID-matlab:convert/epochMint.m:71 (comment_mention)`, `DID-matlab:convert/epochMint.m:73 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:257 (comment_mention)` ...; target(s) BUILT: `ingestion_manifest`
- `epochid` (epoch) -- consumed at 14 site(s), per-document migrator: `DID-matlab:migrators_j/private/jMethodParameters.m:122 (guard)`, `NDI-matlab:ndi_second_pass/bodyResolver.m:348 (guard)`, `NDI-matlab:ndi_second_pass/bodyResolver.m:349 (guard)`, `NDI-matlab:ndi_second_pass/bodyResolver.m:350 (field_read)`, `NDI-matlab:ndi_second_pass/ensembleMembership.m:731 (guard)`, `NDI-matlab:ndi_second_pass/ensembleMembership.m:732 (field_read)` ...; consumed at 1 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:904 (guard)`; a block of this name is WRITTEN at 1 site(s), per-document migrator: `DID-matlab:migrators_j/private/jMethodParameters.m:126 (field_write)`; NAMED as a string value at 10 site(s), per-document migrator: `DID-matlab:migrators_j/epochfiles_ingested.m:265 (named)`, `DID-matlab:migrators_j/private/jMethodParameters.m:123 (named)`, `DID-matlab:migrators_j/pyraview.m:186 (named)`, `DID-matlab:migrators_j/pyraview.m:193 (named)`, `DID-matlab:migrators_j/pyraview.m:198 (named)`, `NDI-matlab:ndi_second_pass/epochAnchorFold.m:479 (named)` ...; NAMED as a string value at 5 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:1962 (named)`, `DID-matlab:convert/epochMint.m:1967 (named)`, `DID-matlab:convert/epochMint.m:744 (named)`, `DID-matlab:convert/epochMint.m:905 (named)`, `DID-matlab:convert/epochMint.m:992 (named)`; mentioned in 78 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:142 (comment_mention)`, `DID-matlab:migrators_j/Contents.m:144 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:22 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:29 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:31 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:35 (comment_mention)` ...; mentioned in 21 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochIndex.m:16 (comment_mention)`, `DID-matlab:convert/epochIndex.m:235 (comment_mention)`, `DID-matlab:convert/epochIndex.m:53 (comment_mention)`, `DID-matlab:convert/epochIndex.m:96 (comment_mention)`, `DID-matlab:convert/epochMint.m:1126 (comment_mention)`, `DID-matlab:convert/epochMint.m:113 (comment_mention)` ...
