...
| open **decision families** | **24** |
| &nbsp;&nbsp;DECIDED and signed off, awaiting build | 24 |
...
The class count is not the work count. 26 open classes are 24 decisions, because most open classes move as a family.

**0 of those 24 are not settled**: 0 awaiting a signature on a decision already taken, 0 written up by Claude alone and unreviewed, 0 with nothing proposed. Only 24 are signed off.
...
| build: migrator files inspected | 178 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 152 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 26 |
| build: V_zeta files DELIBERATELY EXCLUDED (`+migrators`, `+migrators_i`, `+migrators_e`) | 38 |
| build: migrator lines inspected | 40721 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 28096 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 12625 |
...
|---|---|---|---|---|
| 1 | `b.document_class = struct('class_name', '<class>', ...)` | 68 | 53 | 15 |
...
| `DID-matlab:migrators_j/private/jRecordingObservation.m:251` | `e.class` |
...
|---|---|---|---|---|---|---|---|---|
| `acquisition_epoch` | epoch | (b) | 6 consuming reference(s) (1 per-document migrator, 5 batch post-pass); minted as a document class at 1 site(s) (1 per-document migrator) | 1 (1+0) | 1 (1+0) | - | 45 (29+16) | n/a -- not measured |
| `app` | software | (b) | 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `software` | - | 2 (1+1) | 1 (0+1) | 190 (154+36) | n/a -- not measured |
...
| `daqreader` | daq configuration | (b) | migrator `DID-matlab:migrators_j/daqreader.m`; 5 consuming reference(s) (5 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `software` | 1 (1+0) | 2 (2+0) | - | 47 (45+2) | n/a -- not measured |
| `daqreader_epochdata_ingested` | daq ingested payloads | (b) | migrator `DID-matlab:migrators_j/daqreader_epochdata_ingested.m`; 3 consuming reference(s) (3 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `relative_reference` | 1 (1+0) | 2 (2+0) | 2 (2+0) | 27 (20+7) | n/a -- not measured |
| `daqreader_image_epochdata_ingested` | daq ingested payloads | (b) | migrator `DID-matlab:migrators_j/daqreader_image_epochdata_ingested.m`; decided target(s) built: `image_observation`, `relative_reference`, `sampled_body` | - | - | - | 14 (11+3) | n/a -- not measured |
| `daqsystem` | daq configuration | (b) | migrator `DID-matlab:migrators_j/daqsystem.m`; 3 consuming reference(s) (3 per-document migrator); decided target(s) built: `acquisition_system` | - | - | - | 33 (33+0) | n/a -- not measured |
| `ensemble` | ensemble | (b) | 1 consuming reference(s) (1 per-document migrator); decided target(s) built: `subject`, `directed_relation`, `sampled_body` | - | - | - | 24 (22+2) | n/a -- not measured |
...
| `epochfiles_ingested` | epoch | (b) | migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; decided target(s) built: `ingestion_manifest` | - | - | - | 25 (18+7) | n/a -- not measured |
| `epochid` | epoch | (b) | 15 consuming reference(s) (14 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 13 (10+3) | 97 (78+19) | n/a -- not measured |
...
| `ngrid` | image / ngrid | (b) | 6 consuming reference(s) (6 per-document migrator) | - | 1 (1+0) | - | 71 (68+3) | n/a -- not measured |
...
| `stimulus_presentation` | stimulus | (b) | migrator `DID-matlab:migrators_j/stimulus_presentation.m`; 4 consuming reference(s) (4 per-document migrator); decided target(s) built: `timed_sequence`, `timed_sequence_manipulation` | - | - | - | 37 (35+2) | n/a -- not measured |
| `syncgraph` | sync configuration | (b) | migrator `DID-matlab:migrators_j/syncgraph.m`; 2 consuming reference(s) (2 per-document migrator); decided target(s) built: `clock_alignment_policy` | - | - | - | 34 (31+3) | n/a -- not measured |
...
| `time_reference` | time_reference | (b) | 2 consuming reference(s) (1 per-document migrator, 1 batch post-pass) | - | 18 (15+3) | 24 (19+5) | 41 (36+5) | n/a -- not measured |
...
- `ensemble` (ensemble) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/ensembleMembership.m:438 (guard)`; mentioned in 22 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/element.m:112 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:89 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:91 (comment_mention)`, `DID-matlab:migrators_j/element_epoch.m:92 (comment_mention)`, `DID-matlab:migrators_j/private/jAcquisitionChannels.m:73 (comment_mention)`, `DID-matlab:migrators_j/pyraview.m:267 (comment_mention)` ...; mentioned in 2 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/resolveLawnPlateSubjects.m:1358 (comment_mention)`, `DID-matlab:convert/resolveResponseParameters.m:68 (comment_mention)`; target(s) BUILT: `subject`, `directed_relation`, `sampled_body`
...
- `epochfiles_ingested` (epoch) -- migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; mentioned in 18 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:160 (comment_mention)`, `DID-matlab:migrators_j/Contents.m:665 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:115 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:192 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:203 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:220 (comment_mention)` ...; mentioned in 7 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:154 (comment_mention)`, `DID-matlab:convert/epochMint.m:171 (comment_mention)`, `DID-matlab:convert/epochMint.m:210 (comment_mention)`, `DID-matlab:convert/epochMint.m:56 (comment_mention)`, `DID-matlab:convert/epochMint.m:58 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:257 (comment_mention)` ...; target(s) BUILT: `ingestion_manifest`
- `epochid` (epoch) -- consumed at 14 site(s), per-document migrator: `DID-matlab:migrators_j/private/jMethodParameters.m:122 (guard)`, `NDI-matlab:ndi_second_pass/bodyResolver.m:216 (guard)`, `NDI-matlab:ndi_second_pass/bodyResolver.m:217 (guard)`, `NDI-matlab:ndi_second_pass/bodyResolver.m:218 (field_read)`, `NDI-matlab:ndi_second_pass/ensembleMembership.m:731 (guard)`, `NDI-matlab:ndi_second_pass/ensembleMembership.m:732 (field_read)` ...; consumed at 1 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:847 (guard)`; a block of this name is WRITTEN at 1 site(s), per-document migrator: `DID-matlab:migrators_j/private/jMethodParameters.m:126 (field_write)`; NAMED as a string value at 10 site(s), per-document migrator: `DID-matlab:migrators_j/epochfiles_ingested.m:265 (named)`, `DID-matlab:migrators_j/private/jMethodParameters.m:123 (named)`, `DID-matlab:migrators_j/pyraview.m:186 (named)`, `DID-matlab:migrators_j/pyraview.m:193 (named)`, `DID-matlab:migrators_j/pyraview.m:198 (named)`, `NDI-matlab:ndi_second_pass/epochAnchorFold.m:479 (named)` ...; NAMED as a string value at 3 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:687 (named)`, `DID-matlab:convert/epochMint.m:848 (named)`, `DID-matlab:convert/epochMint.m:935 (named)`; mentioned in 78 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:142 (comment_mention)`, `DID-matlab:migrators_j/Contents.m:144 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:22 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:29 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:31 (comment_mention)`, `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m:35 (comment_mention)` ...; mentioned in 19 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochIndex.m:16 (comment_mention)`, `DID-matlab:convert/epochIndex.m:235 (comment_mention)`, `DID-matlab:convert/epochIndex.m:53 (comment_mention)`, `DID-matlab:convert/epochIndex.m:96 (comment_mention)`, `DID-matlab:convert/epochMint.m:1481 (comment_mention)`, `DID-matlab:convert/epochMint.m:150 (comment_mention)` ...
...
- `syncrule_mapping` (sync mapping) -- migrator `DID-matlab:migrators_j/syncrule_mapping.m`; consumed at 2 site(s), per-document migrator: `DID-matlab:migrators_j/syncrule_mapping.m:106 (guard)`, `DID-matlab:migrators_j/syncrule_mapping.m:107 (field_read)`; MINTED as a document class at 1 site(s), per-document migrator: `DID-matlab:migrators_j/syncrule_mapping.m:131 (emitted_class)`; a block of this name is WRITTEN at 1 site(s), per-document migrator: `DID-matlab:migrators_j/syncrule_mapping.m:149 (field_write)`; mentioned in 26 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:892 (comment_mention)`, `DID-matlab:migrators_j/Contents.m:893 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:204 (comment_mention)`, `DID-matlab:migrators_j/private/jClockAlignmentBodies.m:10 (comment_mention)`, `DID-matlab:migrators_j/private/jClockAlignmentBodies.m:170 (comment_mention)`, `DID-matlab:migrators_j/private/jClockAlignmentBodies.m:2 (comment_mention)` ...; mentioned in 3 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:172 (comment_mention)`, `DID-matlab:convert/epochMint.m:174 (comment_mention)`, `DID-matlab:convert/resolveResponseParameters.m:483 (comment_mention)`; target(s) BUILT: `clock_alignment`
- `time_reference` (time_reference) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/epochAnchorFold.m:483 (guard)`; consumed at 1 site(s), batch post-pass: `DID-matlab:convert/resolveSessionAnchors.m:560 (guard)`; a block of this name is WRITTEN at 15 site(s), per-document migrator: `DID-matlab:migrators_j/fitcurve.m:153 (field_write)`, `DID-matlab:migrators_j/image_stack.m:283 (field_write)`, `DID-matlab:migrators_j/jrclust_clusters.m:89 (field_write)`, `DID-matlab:migrators_j/neuron_extracellular.m:122 (field_write)`, `DID-matlab:migrators_j/ontology_table_row.m:280 (field_write)`, `DID-matlab:migrators_j/ontology_table_row.m:874 (field_write)` ...; a block of this name is WRITTEN at 3 site(s), batch post-pass: `DID-matlab:convert/resolveDeferredBaths.m:394 (field_write)`, `DID-matlab:convert/resolveDeferredBaths.m:443 (field_write)`, `DID-matlab:convert/resolveValidIntervals.m:965 (field_write)`; NAMED as a string value at 19 site(s), per-document migrator: `DID-matlab:migrators_j/fitcurve.m:147 (named)`, `DID-matlab:migrators_j/image_stack.m:279 (named)`, `DID-matlab:migrators_j/jrclust_clusters.m:85 (named)`, `DID-matlab:migrators_j/neuron_extracellular.m:118 (named)`, `DID-matlab:migrators_j/ontology_table_row.m:276 (named)`, `DID-matlab:migrators_j/ontology_table_row.m:869 (named)` ...; NAMED as a string value at 5 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:1742 (named)`, `DID-matlab:convert/resolveDeferredBaths.m:386 (named)`, `DID-matlab:convert/resolveDeferredBaths.m:438 (named)`, `DID-matlab:convert/resolveSessionAnchors.m:550 (named)`, `DID-matlab:convert/resolveValidIntervals.m:955 (named)`; mentioned in 36 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/daqreader_epochdata_ingested.m:21 (comment_mention)`, `DID-matlab:migrators_j/neuron_extracellular.m:48 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:172 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:196 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:199 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:214 (comment_mention)` ...; mentioned in 5 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:1691 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:22 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:254 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:269 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:271 (comment_mention)`
...
**DENOMINATOR: 24 signed families. 16 named at least one decided target class and were checked against the built tree; 8 named none and are UNCHECKED HERE.**
...
DENOMINATOR: 24 signed families checked; every V_eta class name in the family one-liner above was matched against the text of the `TEAM-SIGN-OFF` line that signs that family. 10 family/name pair(s) are UNSIGNED -- the prose names the class, the signature does not.
...
DENOMINATOR: 2 row(s), each searched for its BARE CLASS NAME as a quoted literal in 11 batch post-pass file(s) under `+did2/+convert` (comments stripped).
