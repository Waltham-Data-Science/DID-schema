...
| &nbsp;&nbsp;DECIDED and signed off, awaiting build | 10 |
| &nbsp;&nbsp;decided in a walkthrough, **awaiting a signature** | 9 |
...
**9 of those 19 are not settled**: 9 awaiting a signature on a decision already taken, 0 written up by Claude alone and unreviewed, 0 with nothing proposed. Only 10 are signed off.
