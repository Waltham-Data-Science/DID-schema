...
| build: migrator lines inspected | 45718 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30667 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 15051 |
...
| `DID-matlab:convert/resolveEpochProbemap.m:634` | `entry.class` |
