...
| build: migrator lines inspected | 39868 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 27264 |
...
| `app` | software | (b) | 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `software` | - | 2 (1+1) | 1 (0+1) | 182 (146+36) | n/a -- not measured |
