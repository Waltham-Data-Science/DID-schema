...
|---|---|
| build: V_eta migrator packages read | `DID-matlab:migrators_j`, `DID-matlab:convert` |
| build: &nbsp;&nbsp;-- of those, per-document migrator | `DID-matlab:migrators_j` |
| build: &nbsp;&nbsp;-- of those, batch post-pass | `DID-matlab:convert` |
| build: migrator files inspected | 163 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 135 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 28 |
| build: V_zeta files DELIBERATELY EXCLUDED (`+migrators`, `+migrators_i`, `+migrators_e`) | 38 |
| build: migrator lines inspected | 35383 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 20314 |
...
|---|---|---|---|---|
| 1 | `b.document_class = struct('class_name', '<class>', ...)` | 58 | 41 | 17 |
| 2 | `b.document_class = classBlock('<class>', {supers})` | 16 | 15 | 1 |
...
| `DID-matlab:convert/resolveEpochProbemap.m:646` | `entry.class` |
...
| `DID-matlab:migrators_j/private/jCalculation.m:94` | `concreteClass` |
...
|---|---|---|---|---|---|---|---|---|
| `acquisition_epoch` | epoch | (b) | 5 consuming reference(s) (5 batch post-pass); minted as a document class at 1 site(s) (1 per-document migrator) | 1 (1+0) | 1 (1+0) | - | 35 (18+17) | n/a -- not measured |
...
| `daqreader` | daq configuration | (b) | migrator `DID-matlab:migrators_j/daqreader.m`; 5 consuming reference(s) (5 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `software` | 1 (1+0) | 2 (2+0) | - | 47 (41+6) | n/a -- not measured |
...
| `daqsystem` | daq configuration | (b) | migrator `DID-matlab:migrators_j/daqsystem.m`; 3 consuming reference(s) (3 per-document migrator); decided target(s) built: `acquisition_system` | - | - | - | 34 (32+2) | n/a -- not measured |
| `ensemble` | ensemble | (b) | decided target(s) built: `subject`, `directed_relation`, `sampled_body` | - | - | - | 11 (9+2) | n/a -- not measured |
| `epoch_bounded_reference` | time_reference | (a) | *none* | 1 (1+0) discounted | 2 (2+0) | 1 (1+0) | 12 (8+4) | n/a -- not measured |
...
| `epochid` | epoch | (b) | 2 consuming reference(s) (1 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 11 (5+6) | 75 (53+22) | n/a -- not measured |
| `filenavigator` | file navigation | (b) | migrator `DID-matlab:migrators_j/filenavigator.m`; 3 consuming reference(s) (3 per-document migrator); decided target(s) built: `epoch_file_pattern` | - | - | - | 26 (25+1) | n/a -- not measured |
...
| `session_bounded_reference` | time_reference | (b) | 1 consuming reference(s) (1 batch post-pass) | 1 (1+0) discounted | 1 (1+0) | 1 (0+1) | 14 (2+12) | n/a -- not measured |
| `session_relative_reference` | time_reference | (b) | 1 consuming reference(s) (1 batch post-pass) | 11 (9+2) discounted | 11 (9+2) | 1 (0+1) | 29 (16+13) | n/a -- not measured |
| `stimulus_presentation` | stimulus | (b) | migrator `DID-matlab:migrators_j/stimulus_presentation.m`; decided target(s) built: `timed_sequence`, `timed_sequence_manipulation` | - | - | - | 20 (18+2) | n/a -- not measured |
| `syncgraph` | sync configuration | (b) | migrator `DID-matlab:migrators_j/syncgraph.m`; 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `clock_alignment_policy` | - | - | - | 46 (27+19) | n/a -- not measured |
...
| `syncrule_mapping` | sync mapping | (b) | migrator `DID-matlab:migrators_j/syncrule_mapping.m`; 7 consuming reference(s) (2 per-document migrator, 5 batch post-pass); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `clock_alignment` | 1 (1+0) | 1 (1+0) | 2 (0+2) | 45 (25+20) | n/a -- not measured |
| `time_reference` | time_reference | (b) | 4 consuming reference(s) (3 per-document migrator, 1 batch post-pass) | - | 16 (13+3) | 22 (15+7) | 39 (30+9) | n/a -- not measured |

#### (a) decided, nothing built -- 3

- `epoch_bounded_reference` (time_reference) -- MINTED as a document class at 1 site(s), per-document migrator: `DID-matlab:migrators_j/pyraview.m:192 (emitted_class)`; minted at 1 site(s) (1 per-document migrator), NOT counted as build progress: the signed decision retires this class in favour of `relative_reference`, so an emission is work still to undo; a block of this name is WRITTEN at 2 site(s), per-document migrator: `DID-matlab:migrators_j/pyraview.m:205 (field_write)`, `DID-matlab:migrators_j/pyraview.m:223 (field_write)`; NAMED as a string value at 1 site(s), per-document migrator: `DID-matlab:migrators_j/syncrule_mapping.m:182 (named)`; mentioned in 8 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/pyraview.m:148 (comment_mention)`, `DID-matlab:migrators_j/pyraview.m:161 (comment_mention)`, `DID-matlab:migrators_j/pyraview.m:183 (comment_mention)`, `DID-matlab:migrators_j/pyraview.m:219 (comment_mention)`, `DID-matlab:migrators_j/pyraview.m:76 (comment_mention)`, `DID-matlab:migrators_j/stimulus_bath.m:23 (comment_mention)` ...; mentioned in 4 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/resolveDeferredBaths.m:15 (comment_mention)`, `DID-matlab:convert/resolveDeferredBaths.m:47 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:108 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:72 (comment_mention)`
...
DENOMINATOR: 27 signed families checked; every V_eta class name in the family one-liner above was matched against the text of the `TEAM-SIGN-OFF` line that signs that family. 22 family/name pair(s) are UNSIGNED -- the prose names the class, the signature does not.
