...
| build: migrator lines inspected | 39452 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 26848 |
...
| `ensemble` | ensemble | (b) | 1 consuming reference(s) (1 per-document migrator); decided target(s) built: `subject`, `directed_relation`, `sampled_body` | - | - | - | 22 (20+2) | n/a -- not measured |
