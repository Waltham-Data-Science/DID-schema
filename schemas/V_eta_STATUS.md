...
| build: migrator files inspected | 168 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 143 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 25 |
| build: V_zeta files DELIBERATELY EXCLUDED (`+migrators`, `+migrators_i`, `+migrators_e`) | 38 |
| build: migrator lines inspected | 36674 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 24891 |
...
| 2 | `b.document_class = classBlock('<class>', {supers})` | 16 | 16 | 0 |
...
|---|---|---|---|---|---|---|---|---|
| `acquisition_epoch` | epoch | (b) | 1 consuming reference(s) (1 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator) | 1 (1+0) | 1 (1+0) | - | 28 (27+1) | n/a -- not measured |
| `app` | software | (b) | 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `software` | - | 2 (1+1) | 1 (0+1) | 177 (141+36) | n/a -- not measured |
| `binaryseries_parameters` | misc singletons | (b) | migrator `DID-matlab:migrators_j/binaryseries_parameters.m`; decided target(s) built: `subject_statement`, `sampled_body` | - | - | 1 (1+0) | 11 (11+0) | n/a -- not measured |
...
| `daqmetadatareader_epochdata_ingested` | daq ingested payloads | (b) | migrator `DID-matlab:migrators_j/daqmetadatareader_epochdata_ingested.m`; 2 consuming reference(s) (2 batch post-pass); decided target(s) built: `acquisition_metadata_file` | - | - | 2 (0+2) | 14 (9+5) | n/a -- not measured |
| `daqreader` | daq configuration | (b) | migrator `DID-matlab:migrators_j/daqreader.m`; 4 consuming reference(s) (4 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `software` | 1 (1+0) | 2 (2+0) | - | 39 (37+2) | n/a -- not measured |
| `daqreader_epochdata_ingested` | daq ingested payloads | (b) | migrator `DID-matlab:migrators_j/daqreader_epochdata_ingested.m`; 3 consuming reference(s) (3 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `relative_reference` | 1 (1+0) | 2 (2+0) | 2 (2+0) | 23 (18+5) | n/a -- not measured |
| `daqreader_image_epochdata_ingested` | daq ingested payloads | (b) | migrator `DID-matlab:migrators_j/daqreader_image_epochdata_ingested.m`; decided target(s) built: `image_observation`, `relative_reference`, `sampled_body` | - | - | - | 8 (5+3) | n/a -- not measured |
| `daqsystem` | daq configuration | (b) | migrator `DID-matlab:migrators_j/daqsystem.m`; 3 consuming reference(s) (3 per-document migrator); decided target(s) built: `acquisition_system` | - | - | - | 26 (26+0) | n/a -- not measured |
...
| `epochfiles_ingested` | epoch | (b) | migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; decided target(s) built: `ingestion_manifest` | - | - | - | 16 (11+5) | n/a -- not measured |
...
| `ngrid` | image / ngrid | (b) | 6 consuming reference(s) (6 per-document migrator) | - | 1 (1+0) | - | 60 (57+3) | n/a -- not measured |
...
| `syncrule_mapping` | sync mapping | (b) | migrator `DID-matlab:migrators_j/syncrule_mapping.m`; 2 consuming reference(s) (2 per-document migrator); minted as a document class at 1 site(s) (1 per-document migrator); decided target(s) built: `clock_alignment` | 1 (1+0) | 1 (1+0) | - | 28 (25+3) | n/a -- not measured |
...
- `epochfiles_ingested` (epoch) -- migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; mentioned in 11 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/Contents.m:160 (comment_mention)`, `DID-matlab:migrators_j/Contents.m:654 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:121 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:39 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:60 (comment_mention)`, `DID-matlab:migrators_j/epochfiles_ingested.m:94 (comment_mention)` ...; mentioned in 5 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:109 (comment_mention)`, `DID-matlab:convert/epochMint.m:126 (comment_mention)`, `DID-matlab:convert/epochMint.m:165 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:238 (comment_mention)`, `DID-matlab:convert/resolveValidIntervals.m:116 (comment_mention)`; target(s) BUILT: `ingestion_manifest`
