...
| build: migrator lines inspected | 44500 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30667 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 13833 |
...
|---|---|---|---|---|
| 1 | `b.document_class = struct('class_name', '<class>', ...)` | 71 | 56 | 15 |
...
| `epochfiles_ingested` | epoch | (b) | migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; 5 consuming reference(s) (5 batch post-pass); decided target(s) built: `ingestion_manifest` | - | - | - | 32 (18+14) | n/a -- not measured |
...
| `time_reference` | time_reference | (b) | 5 consuming reference(s) (4 per-document migrator, 1 batch post-pass) | - | 18 (15+3) | 25 (19+6) | 45 (37+8) | n/a -- not measured |
