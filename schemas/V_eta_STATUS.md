...
The class count is not the work count. 26 open classes are 25 decisions, because most open classes move as a family.

**0 of those 25 are not settled**: 0 awaiting a signature on a decision already taken, 0 written up by Claude alone and unreviewed, 0 with nothing proposed. Only 25 are signed off.
...
**DENOMINATOR: 25 signed families. 16 named at least one decided target class and were checked against the built tree; 9 named none and are UNCHECKED HERE.**
...
DENOMINATOR: 25 signed families checked; every V_eta class name in the family one-liner above was matched against the text of the `TEAM-SIGN-OFF` line that signs that family. 10 family/name pair(s) are UNSIGNED -- the prose names the class, the signature does not.
