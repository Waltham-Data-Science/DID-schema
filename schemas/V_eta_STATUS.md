...
| build: migrator files inspected | 164 |
...
| build: migrator lines inspected | 30715 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 21085 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 9630 |
...
| `epochid` | epoch | (b) | 12 consuming reference(s) (11 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 9 (7+2) | 80 (71+9) | n/a -- not measured |
...
DENOMINATOR: 2 row(s), each searched for its BARE CLASS NAME as a quoted literal in 9 batch post-pass file(s) under `+did2/+convert` (comments stripped).
