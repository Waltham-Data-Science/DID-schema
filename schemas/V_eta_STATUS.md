...
| build: migrator lines inspected | 38255 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 26225 |
...
| `epoch_bounded_reference` | time_reference | (b) | 11 consuming reference(s) (11 per-document migrator) | 2 (2+0) discounted | 3 (3+0) | 2 (2+0) | 36 (32+4) | n/a -- not measured |
