...
| build: migrator lines inspected | 45350 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30667 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 14683 |
...
|---|---|---|---|---|
| 1 | `b.document_class = struct('class_name', '<class>', ...)` | 72 | 56 | 16 |
...
| `DID-matlab:convert/resolveEpochProbemap.m:472` | `entry.class` |
...
| `epochfiles_ingested` | epoch | (b) | migrator `DID-matlab:migrators_j/epochfiles_ingested.m`; 13 consuming reference(s) (13 batch post-pass); decided target(s) built: `ingestion_manifest` | - | - | - | 40 (18+22) | n/a -- not measured |
| `epochid` | epoch | (b) | 15 consuming reference(s) (14 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 16 (10+6) | 99 (78+21) | n/a -- not measured |
