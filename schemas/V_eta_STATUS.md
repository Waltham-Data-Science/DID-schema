...
| build: migrator lines inspected | 29816 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 20365 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 9451 |
...
| `epochid` | epoch | (b) | 12 consuming reference(s) (11 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 8 (7+1) | 79 (71+8) | n/a -- not measured |
