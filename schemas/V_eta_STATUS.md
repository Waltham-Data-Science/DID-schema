...
| build: migrator lines inspected | 45648 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30667 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 14981 |
...
| `DID-matlab:convert/resolveEpochProbemap.m:607` | `entry.class` |
