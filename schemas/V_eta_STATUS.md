...
| build: migrator lines inspected | 45890 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30821 |
...
| `epochid` | epoch | (b) | 15 consuming reference(s) (14 per-document migrator, 1 batch post-pass) | - | 1 (1+0) | 16 (10+6) | 103 (81+22) | n/a -- not measured |
...
| `stimulus_presentation` | stimulus | (b) | migrator `DID-matlab:migrators_j/stimulus_presentation.m`; 6 consuming reference(s) (6 per-document migrator); decided target(s) built: `timed_sequence`, `timed_sequence_manipulation` | - | - | - | 46 (44+2) | n/a -- not measured |
