...
| build: migrator lines inspected | 42882 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 30257 |
...
| `app` | software | (b) | 5 consuming reference(s) (2 per-document migrator, 3 batch post-pass); decided target(s) built: `software` | - | 2 (1+1) | 1 (0+1) | 197 (161+36) | n/a -- not measured |
...
- `time_reference` (time_reference) -- consumed at 1 site(s), per-document migrator: `NDI-matlab:ndi_second_pass/epochAnchorFold.m:483 (guard)`; consumed at 1 site(s), batch post-pass: `DID-matlab:convert/resolveSessionAnchors.m:560 (guard)`; a block of this name is WRITTEN at 15 site(s), per-document migrator: `DID-matlab:migrators_j/fitcurve.m:153 (field_write)`, `DID-matlab:migrators_j/image_stack.m:283 (field_write)`, `DID-matlab:migrators_j/jrclust_clusters.m:89 (field_write)`, `DID-matlab:migrators_j/neuron_extracellular.m:361 (field_write)`, `DID-matlab:migrators_j/ontology_table_row.m:280 (field_write)`, `DID-matlab:migrators_j/ontology_table_row.m:874 (field_write)` ...; a block of this name is WRITTEN at 3 site(s), batch post-pass: `DID-matlab:convert/resolveDeferredBaths.m:394 (field_write)`, `DID-matlab:convert/resolveDeferredBaths.m:443 (field_write)`, `DID-matlab:convert/resolveValidIntervals.m:965 (field_write)`; NAMED as a string value at 19 site(s), per-document migrator: `DID-matlab:migrators_j/fitcurve.m:147 (named)`, `DID-matlab:migrators_j/image_stack.m:279 (named)`, `DID-matlab:migrators_j/jrclust_clusters.m:85 (named)`, `DID-matlab:migrators_j/neuron_extracellular.m:357 (named)`, `DID-matlab:migrators_j/ontology_table_row.m:276 (named)`, `DID-matlab:migrators_j/ontology_table_row.m:869 (named)` ...; NAMED as a string value at 5 site(s), batch post-pass: `DID-matlab:convert/epochMint.m:1742 (named)`, `DID-matlab:convert/resolveDeferredBaths.m:386 (named)`, `DID-matlab:convert/resolveDeferredBaths.m:438 (named)`, `DID-matlab:convert/resolveSessionAnchors.m:550 (named)`, `DID-matlab:convert/resolveValidIntervals.m:955 (named)`; mentioned in 36 COMMENT(s) -- prose, counts toward nothing, per-document migrator: `DID-matlab:migrators_j/daqreader_epochdata_ingested.m:21 (comment_mention)`, `DID-matlab:migrators_j/neuron_extracellular.m:250 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:172 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:196 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:199 (comment_mention)`, `DID-matlab:migrators_j/ontology_table_row.m:214 (comment_mention)` ...; mentioned in 5 COMMENT(s) -- prose, counts toward nothing, batch post-pass: `DID-matlab:convert/epochMint.m:1691 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:22 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:254 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:269 (comment_mention)`, `DID-matlab:convert/resolveSessionAnchors.m:271 (comment_mention)`
