...
| build: migrator files inspected | 171 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 146 |
| build: &nbsp;&nbsp;-- of those, batch post-pass | 25 |
| build: V_zeta files DELIBERATELY EXCLUDED (`+migrators`, `+migrators_i`, `+migrators_e`) | 38 |
| build: migrator lines inspected | 37835 |
| build: &nbsp;&nbsp;-- of those, per-document migrator | 25861 |
