# Conversion: did_v1 → V_eta — `spatial_frequency_tuning`

## Identity

- **V_eta `class_name`:** `spatial_frequency_tuning`
- **V_eta tier:** `stable`
- **V_eta schema path:** `schemas/V_eta/stable/spatial_frequency_tuning.json`
