# Conversion: did_v1 → V_eta — `contrast_sensitivity_calc`

## Identity

- **V_eta `class_name`:** `contrast_sensitivity_calc`
- **V_eta tier:** `stable`
- **V_eta schema path:** `schemas/V_eta/stable/contrast_sensitivity_calc.json`
