...
**102 v1 source classes** (91 NDI/main + 11 vhlab app) | by V_eta disposition: consumed by migrator (no tombstone)=27, dissolved → subject=1, in_progress=19, no V_eta home, no migrator -- UNVERIFIED=4, persist=4, retire=44, test/demo fixture (non-production)=3 | 62 have a bespoke migrator.
...
| `oneepoch` | — | no V_eta home, no migrator -- UNVERIFIED | ndi |
