...
**102 v1 source classes** (91 NDI/main + 11 vhlab app) | by V_eta disposition: UNMAPPED (needs a V_eta home)=1, consumed by migrator (no tombstone)=28, dissolved → subject=1, in_progress=21, no V_eta home, no migrator -- UNVERIFIED=4, persist=4, retire=41, test/demo fixture (non-production)=2 | 61 have a bespoke migrator | ⚠ 1 UNMAPPED (no V_eta class, no migrator).
...
| `subjectmeasurement` | ⚠ **unmapped** | UNMAPPED (needs a V_eta home) | ndi |
